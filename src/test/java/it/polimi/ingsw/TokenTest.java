...
public class TokenTest {
    ...
    @Test
    public void newToken_CorrectBehavior_AssertEquals () {
        ...
        Token token5 = new Token(2);
        assertEquals(token5.getPoints(), 2, 0);
        assertEquals(token5.getType(), TokenType.SCORING);
    }
    ...
    @Test
    public void setId_AssertEquals(){
        Token token = new Token(1);
        assertEquals(token.getId(), 1);
    }

    @Test
    public void setPoints_NoThrowsExpected(){
        Token token = new Token(1);
        token.setPoints(4);
    }
