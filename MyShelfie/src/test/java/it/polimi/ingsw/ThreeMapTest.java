...
public class ThreeMapTest {
    ...
    public void addKey_setPlayer_CorrectInput_CorrectOutput(){
        ...
        ArrayList<it.polimi.ingsw.model.Player> players = new ArrayList<>();
        it.polimi.ingsw.model.Game game0 = new it.polimi.ingsw.model.Game(0);
        ...
        it.polimi.ingsw.model.Player player0 = new it.polimi.ingsw.model.Player(false, new Shelf(), "player0", state, personalGoal0, game0);
        it.polimi.ingsw.model.Player player1 = new it.polimi.ingsw.model.Player(false, new Shelf(), "player1", state, personalGoal0, game0);
        it.polimi.ingsw.model.Player player2 = new it.polimi.ingsw.model.Player(false, new Shelf(), "player2", state, personalGoal0, game0);
        it.polimi.ingsw.model.Player player3 = new it.polimi.ingsw.model.Player(false, new Shelf(), "player3", state, personalGoal0, game0);
